    ...
    <div className="login-container flex justify-center items-center h-screen bg-bg-color">
      ...
      {alert&& 
        <div className='text-center text-whi flex justify-center'>
          <p className='bg-light-red p-2 rounded-sm text-xl mb-4'>ادخل كلمة السر الصحيحه!</p></div>
      }
        ...
        <input
          ...
          className="mb-3 p-2 border rounded w-full bg-gray-100 placeholder:text-paleGray"
        />
        <button type="submit" className="w-full p-2 bg-paleOrange hover:bg-darkOrange hover:shadow-md hover:shadow-darkgray transition-all text-white rounded">
          Log In
        </button>
      </form>
    </div>
